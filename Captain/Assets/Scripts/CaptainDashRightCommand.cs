...
namespace Captain.Command
{
     ...
     * 
     * Note: for use only with Right movements. */
    public class CaptainDashRightCommand : ScriptableObject, ICaptainCommand
    {
        ...
        public void Execute(GameObject gameObject)
        {
            ...
            else // reset timer
            {
                ...
                if (rigidBody != null)
                {
                    rigidBody.velocity = Vector2.right * DashSpeed; // add the actual dash
